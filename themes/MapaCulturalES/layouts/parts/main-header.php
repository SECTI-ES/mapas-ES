            ...
            <template #default>
                ...
                <li>
                    ...
                    <a href="<?= $app->createUrl('site', 'index') ?>" class="mc-header-menu--item home">
                        <span class="icon">
                            <img class="icon-menu" src="<?php $this->asset($app->config['icons.menu']['home']) ?>" alt="SVG Icon Home">
                        </span>
                ...
                <li v-if="global.enabledEntities.opportunities">
                    ...
                    <a href="<?= $app->createUrl('search', 'opportunities') ?>" class="mc-header-menu--item opportunity">
                        <span class="icon opportunity__hover--bg">
                            <img class="icon-menu" src="<?php $this->asset($app->config['icons.menu']['opportunities']) ?>" alt="SVG Icon Opportunities">
                        </span>
                ...
                <li v-if="global.enabledEntities.agents">
                    ...
                    <a href="<?= $app->createUrl('search', 'agents') ?>" class="mc-header-menu--item agent">
                        <span class="icon">
                            <img class="icon-menu" src="<?php $this->asset($app->config['icons.menu']['agents']) ?>" alt="SVG Icon Agents">
                        </span>
                ...
                <li v-if="global.enabledEntities.events">
                    ...
                    <a href="<?= $app->createUrl('search', 'events') ?>" class="mc-header-menu--item event">
                        <span class="icon">
                            <img class="icon-menu" src="<?php $this->asset($app->config['icons.menu']['events']) ?>" alt="SVG Icon Events">
                        </span>
                ...
                <li v-if="global.enabledEntities.spaces">
                    ...
                    <a href="<?= $app->createUrl('search', 'spaces') ?>" class="mc-header-menu--item space">
                        <span class="icon">
                            <img class="icon-menu" src="<?php $this->asset($app->config['icons.menu']['spaces']) ?>" alt="SVG Icon Spaces">
                        </span>
                ...
                <li v-if="global.enabledEntities.projects">
                    ...
                    <a href="<?= $app->createUrl('search', 'projects') ?>" class="mc-header-menu--item project">
                        <span class="icon">
                            <img class="icon-menu" src="<?php $this->asset($app->config['icons.menu']['projects']) ?>" alt="SVG Icon Projects">
                        </span>
