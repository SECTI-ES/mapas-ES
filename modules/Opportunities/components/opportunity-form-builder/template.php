                ...
                <template #default>
                    <div class="input-group grid-12">
                        <div v-if="entity.isFirstPhase" class="col-12">
                            <h4 class="input-group__title"><?= i::__("Habilitar campo para vínculo de pessoa jurídica") ?></h4>
                            <h6 class="input-group__subtitle"><?= i::__("Permite que o inscrito vincule uma Pessoa Jurídica com a sua inscrição.") ?></h6>
            ...
            <mc-card class="col-12">
                <template #default>
                    <div v-if="entity.isFirstPhase" class="col-12">
                        ...
                        <h6 class="input-group__subtitle"><?= i::__("Permite a vinculação de instituições (Pessoa Jurídica) no momento da inscrição.") ?></h6>
                        <div class="input-group__inputs">
